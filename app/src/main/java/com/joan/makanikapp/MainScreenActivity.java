...
//        mRadioGroup.check(R.id.forMe);
//        mRadioGroup.check(R.id.forOther);
//
//
...
//                Intent intent = new Intent(MainScreenActivity.this, UserLoginActivity.class);
...
//                    pickupMarker = mMap.addMarker(new MarkerOptions().position(pickupLocation).title("Service Done Here").icon(BitmapDescriptorFactory.fromResource(R.mipmap.ic_pickup)));
//
